...
var MapBase = {
  ...
  init: function() {
    ...
    mapLayers['Local'] = L.tileLayer('file:///storage/emulated/0/zzz/rdr/assets/maps/darkmode/{z}/{x}_{y}.jpg', {
      noWrap: true,
      bounds: boundsTiles
    });
  ...
  addMarkerOnMap: function(marker) {
    ...
    var tempMarker = L.marker([marker.lat, marker.lng], {
      ...
      icon: new L.Icon.DataMarkup({
        iconUrl: './assets/images/icons/' + marker.category + '_' + (marker.category == 'random' ? 'gray' : MapBase.getIconColor(isWeekly ? 'weekly' : 'day_' + day)) + '.png',
        iconSize: [35, 45],
        iconAnchor: [17, 42],
        popupAnchor: [1, -32],
        shadowAnchor: [10, 12],
