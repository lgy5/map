...
var categoriesDisabledByDefault = [
  'treasure', 'american_flowers', 'treasure_hunter', 'tree_map', 'egg_encounter', 'grave_robber'
]
var plantsDisabled = [];
...
var avaliableLanguages = ['ar-ar', 'de-de', 'zh-s', 'es-es', 'fr-fr', 'it-it', 'pt-br', 'pl', 'ru', 'th-th', 'zh-s', 'zh-t'];
var lang;
...
function init() {
  ...
  wikiLanguage['zh-s'] = 'https://github.com/jeanropke/RDR2CollectorsMap/wiki/RDO-Collectors-Map-User-Guide-(English)';
